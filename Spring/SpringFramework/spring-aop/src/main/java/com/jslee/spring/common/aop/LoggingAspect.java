package com.jslee.spring.common.aop;
...
@Component					// 스프링 빈 등록
@Aspect						// AOP에서 횡단 관심사로 지정하는 어노테이션
public class LoggingAspect {
	 ...
	 */
	// 반환타입 패키지.클래스.메소드
	@Before("execution(* com.jslee.spring.service.BoardService*.*(..))")
	...
	@After("execution(* com.jslee.spring.service.BoardService*.*(..))")
	 ...
	 * - proceed() 			: 대상 메소드 호출
	 */
	@Around("execution(* com.jslee.spring.service.BoardService*.*(..))")
	...
	@AfterReturning(pointcut = "execution(* com.jslee.spring.service.BoardServiceImpl.*(..))", returning = "result")
	...
	@AfterThrowing(pointcut = "execution(* com.jslee.spring.service.BoardService*.*(..))", throwing ="exception")
