 ...
 * RESTful
 * 게시판 컨트롤러
 * GET    - /rest/board/   : 목록 화면 - param
 * GET    - /rest/board/10 : 조회 화면 - param
 * POST   - /rest/board/   : 등록 처리 - body
 * PUT    - /rest/board/   : 수정 처리 - body
 * DELETE - /rest/board/10 : 삭제 처리 - param
 */
@RestController
